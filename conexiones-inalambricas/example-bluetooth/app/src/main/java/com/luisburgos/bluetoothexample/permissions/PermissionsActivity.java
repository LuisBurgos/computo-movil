package com.luisburgos.bluetoothexample.permissions;
...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_PERMISSIONS = "com.luisburgos.bluetoothexample.permissions.EXTRA_PERMISSIONS";
